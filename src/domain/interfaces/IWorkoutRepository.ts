...
export interface IWorkoutRepository {
    ...
    getWorkoutsByUserId(userId:IdDTO,searchFilterQuery:GetWorkoutQueryDTO):Promise<{workoutList:Workout[],  paginationData:PaginationDTO}>
    deleteWorkoutSet(setId:IdDTO):Promise<Workout | null>
    markAsCompleted(setId:IdDTO):Promise<Workout | null>
    getUserDashBoardChartData(searchFilterQuery:CustomUserDashBoardQueryDTO):Promise<WorkoutChartData[]>
