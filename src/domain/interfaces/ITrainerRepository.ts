...
export interface ITrainerRepository {
  ...
  updateTrainerSpecificData(trainerUpdate:TrainerDTO):Promise<TrainerSpecific| null>
  getTrainers(searchFilterQuery:GetTrainersQueryDTO):Promise<{trainersList:Trainer[],paginationData:PaginationDTO}>
  getTrainerDetailsByUserIdRef(userId:IdDTO):Promise<Trainer>
  approveRejectTrainerVerification(verificationData:TrainerVerificationDTO):Promise<Trainer | null>
  ...
  getApprovedTrainerDetailsWithSub(trainerId:IdDTO):Promise<TrainerWithSubscription>
  getApprovalPendingList(searchFilterQuery:GetTrainersApprovalQueryDTO):Promise<{trainersList:Trainer[],paginationData:PaginationDTO}>
