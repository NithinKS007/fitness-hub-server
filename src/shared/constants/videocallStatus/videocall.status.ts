export enum VideoCallStatus {
  CreateFailed = "An error occurred while creating the video call log.",
  RetrievedSuccess = "The video call logs have been successfully retrieved.",
  RetrieveFailed = "Failed to retrieve video call logs,Please try again",
