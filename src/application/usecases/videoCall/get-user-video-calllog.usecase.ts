...
import { GetUserVideoCallLogDTO } from "@application/dtos/query-dtos";
...
import { URCallLogUILayer } from "@infrastructure/mappers/call-log.mapper";
...
export class GetUserVideoCallLogUseCase implements IGetUserVideoCallLogUC {
  ...
  async execute({
    ...
    search,
    filters,
  }: GetUserVideoCallLogDTO): Promise<{
    ...
    const { data: userVideoCallLogList, pagination: paginationData } =
