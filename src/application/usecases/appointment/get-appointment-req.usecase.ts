...
import { GetBookingRequestsDTO } from "../../dtos/query-dtos";

/*  
    Purpose: Retrieve a list of booking requests for a specific trainer with pagination and filters
    Incoming: { trainerId, page, limit, fromDate, toDate, search, filters } (Trainer's ID and query parameters for filtering)
